 ...
 * =====================================
 * 1) "/proxy" - redirects *all* calls (all paths and queries) to the remote CocktailDB API
 * and return the results as JSON data.
 *
 ...
 *
 * 4) "/drink-of-the-day" - retrieves the drink associated with a supplied date from the local
 * in-memory DB as JSON.
 *
